        ...
        <form method="post" action="/student/" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="text" name="parent_name" placeholder="Enter your Parent Name" id="pname"
                    value="{{ old('parent_name') }}" class="form-control">
            </div>
            <br>
            <div>
                ...
                <input type="text" name="parent_mobile" placeholder="Enter Parent Mobile Number" id="pmobile"
                    value="{{ old('parent_mobile') }}" class="form-control" accept="[0-9]{10}">
            </div>
            <br>
            <div>
                ...
                <div class="form-control">
                    <input type="radio" checked value="male" name="gender" id="m">&nbsp <label
                        for="m">Male</label>
                    <input type="radio" value="female" name="gender" id="f"> {{(old('gender')=='female')?"checked":""}}<label for="f">Female</label>
                </div>
                <br>
            </div>
            ...
            <div>
                ...
                <input type="email" name="email" class="form-control" value="{{old('email')}}" placeholder="Enter Email ID" id="email">
            </div>
            <br>
            <div>
                <h4><label for="referance_by" style="color:#960dad">Referance By:</label></h4>
                <input type="text" name="referance_by" value="{{old('refrence_by')}}"placeholder="Who Tell You About Axixa" id="referance_by"
                    class="form-control">
            </div>
            <br>
            <div>
            ...
            <input type="date" name="doj" id="doj" value="{{ date('Y-m-d') }}" class="form-control" 
                max="{{(old('doj'))?old('doj'): date('Y-m-d') }}" required>
            <div>
                <h4> <label for="address" style="color:#960dad">Address:</label> </h4>
                <textarea name="address" rows="5" class="form-control"  placeholder="Enter Address Here">{{old('address')}}</textarea>
            </div>
            <br>
            <div>
